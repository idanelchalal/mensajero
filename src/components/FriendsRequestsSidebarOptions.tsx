...
const FriendsRequestsSidebarOptions: FC<FriendsRequestsSidebarOptionsProps> = ({
  ...
  return (
    <Link
      ...
      className="text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex items-center gap-x-3 rounded-md p-2 hover:border text-sm leading-6 font-semibold"
    >
